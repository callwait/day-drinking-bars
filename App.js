...
export const TabStack = TabNavigator(
  {
    Home: { screen: HomeStack,
      navigationOptions: {
        tabBarLabel: '',
        tabBarIcon: ({ tintColor }) => <Icon type="Feather" name="map" style={{fontSize:20,color:tintColor}} />
      }
    },
    MyProfile: { screen: MyProfileStack,
      navigationOptions: {
        tabBarLabel: '',
        tabBarIcon: ({ tintColor }) => <Icon type="Feather" name="users" style={{fontSize:20,color:tintColor}} />
      }
    },
    Settings: { screen: SettingsStack,
      navigationOptions: {
        tabBarLabel: '',
        tabBarIcon: ({ tintColor }) => <Icon type="Feather" name="sliders" style={{fontSize:20,color:tintColor}} />
      }
    },
  },
   {
