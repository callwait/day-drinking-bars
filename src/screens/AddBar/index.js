...
export default class AddBar extends React.Component {
  ...
  _addBar() {  
    ...
    const { barname,bardetails,baraddress, createdate, updatedate, imageUrl } = this.state;
  ...
  render() {
    ...
    return (          
      ...
      <View style={Styles.bottomView}>
       ...
       <TextInput
        ...
        <View style={{alignItems:'center'}}>
          ...
          <TouchableOpacity onPress={this.uploadImage1.bind(this)}>         
           <Image style={Styles.addPhotoImage} source={ this.state.avatarSource == null ? require('../../../assets/img/defaultaddPhoto.png') : this.state.avatarSource } />             
          </TouchableOpacity>   
        ...
        <View style={Styles.addView}>            
            <ListView
              ...
              renderRow={data => (
                <View style={Styles.addView}>                                  
                  <Image style={Styles.addDefaultImage} source={ this.state.avatarSource == null ? require('../../../assets/img/addDefaultImage.png') : {uri: data.url} } />                              
                 
                </View>)}
              />
            </View>
        <TouchableOpacity style={Styles.buttonAddBar} onPress={this._addBar.bind(this)}>
       ...
       <Toast ref="toast"
         style={{backgroundColor:'red', width: '90%', justifyContent: 'center', alignItems: 'center'}}
         position='top'
         positionValue={70}
         fadeInDuration={750}
       ...
       <Toast ref="toastgreen"
         style={{backgroundColor:'#167c04', width: '90%', justifyContent: 'center', alignItems: 'center'}}
         position='top'
         positionValue={70}
         fadeInDuration={750}
         fadeOutDuration={3000}
