...
ratingCompleted(rating) {
  ...
  */
  componentWillMount() {
    AsyncStorage.getItem('UserFullName').then(function(value) {
      console.log(value)
 ...
 */
  _AddReview() {
    ...
    const { userfullname,reviewtitle,reviewdesc,createdate,updatedate,rating} = this.state;
    const newReview = {
        ReviewId:ReviewId,
    ...
    else
    {
        ...
        BarRef.on('value', (dataSnapshot) => {
          dataSnapshot.forEach((child) => {
            ...
            if (child.key == barid)
            {
              BarRef.child(child.key).child('Review_Info').set({ReviewId: ReviewId});
  ...
  render() {
    ...
    return (          
      ...
      <View>
        ...
        <TouchableOpacity style={Styles.buttonAddBar}  onPress={this._AddReview.bind(this)}>
